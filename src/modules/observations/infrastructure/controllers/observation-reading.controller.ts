...
export class ObservationReadingController {
  ...
  async createObservationReading(
    @Payload() observationRequest: CreateObservationReadingRequest,
  ) {
    return this.observationReadingService.createObservationReading(
      observationRequest,
    );
  }
  ...
  async getObservationsByReadingId(@Payload() data: { readingId: number }) {
    return this.observationReadingService.getObservationsByReadingId(
      data.readingId,
    );
  }
  ...
  async getObservationDetailsByCadastralKey(
    @Payload() data: { cadastralKey: string },
  ) {
    return this.observationReadingService.getObservationDetailsByCadastralKey(
      data.cadastralKey,
    );
  }
