...
import { CreatePhotoReadingRequest } from '../../application/dtos/request/create.photo-reading.request';

@Controller('photo-reading')
export class PhotoReadingController {
  constructor(private readonly photoReadingService: PhotoReadingService) {}
  ...
  async getPhotoReadingsByCadastralKey(
    ...
    return this.photoReadingService.getPhotoReadingsByCadastralKey(
      data.cadastralKey,
    );
  }
}
