...
export class IncidentModel {
  constructor(
    ...
    public readonly evidencePhotos?: Array<{ photoId: number; filePath: string; type: string }> | null,
    public readonly statusHistory?: Array<{ changeDate: string | Date; previousStatus: string | null; newStatus: string; managedBy: string | null; observation: string | null }> | null,
  ) {}
